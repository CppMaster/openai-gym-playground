...
env = HerEnv(random_goal=True, epsilon=epsilon)
env_eval = HerEnv(random_goal=False, epsilon=epsilon)
...
model = DQN('MultiInputPolicy', env, verbose=1, replay_buffer_class=replay_buffer_class, replay_buffer_kwargs=replay_buffer_kwargs,
            tensorboard_log="temp/her", learning_rate=4e-3, batch_size=128, buffer_size=10000, learning_starts=1000,
