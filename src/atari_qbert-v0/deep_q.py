...
from baselines.common.atari_wrappers import wrap_deepmind, MaxAndSkipEnv, EpisodicLifeEnv, WarpFrame, \
...
def create_q_model():
    ...
    layer5 = layers.LeakyReLU(0.1)(layer5)
    critic = layers.Dense(num_actions, activation="linear")(layer5)

    return keras.Model(inputs=inputs, outputs=critic)
    ...
    for timestep in range(1, max_steps_per_episode):
        ...
        if frame_count % update_after_actions == 0 and len(done_history) > batch_size:
            ...
            with summary_writer.as_default(frame_count):
                ...
                tf.summary.scalar("exploration chance", epsilon)
        ...
        if frame_count % update_target_network == 0:
            ...
            model_target.save(f"temp/model_{run_suffix}.h5")
